...
public class RestJpaLifecycleProvider implements ContainerRequestFilter, ContainerResponseFilter {
	...
	/**
	 * Returns the entity manager factory associated with the given persistence unit.
	 * @param persistenceUnitName the persistence unit name
	 * @return the entity manager factory
	 * @throws NullPointerException if the given argument is null
	 * @throws IllegalArgumentException if there is no lifecycle provider associated with the given persistence unit
	 */
	static public EntityManagerFactory entityManagerFactory (final String persistenceUnitName) throws NullPointerException, IllegalArgumentException, IllegalStateException {
		if (persistenceUnitName == null) throw new NullPointerException();
	 ...
	 * @return the entity manager associated with the current thread, or null for none
	 */
