...
public class JSON {
	 ...
	 *         null nor an instance of {@code Boolean}, {@code Number}, {@code CharSequence},
	 ...
	 * the resulting object is either null, or a {@code Boolean} value, or a {@code Double}
	...
	/**
	 * Converts the given JSON representation into null.
	 * @param json the JSON representation
	 ...
	 * @throws NullPointerException if the given JSON argument is null
